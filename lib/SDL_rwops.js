...
var __sbuf = exports.__sbuf = Struct({
	_base: uchar_ptr,
	_size: int32,
})
var __sFILEX = exports.__sFILEX = Struct({
})
var __sFILEX_ptr = exports.__sFILEX_ptr = ref.refType(__sFILEX)
var c__S___sFILE_FI__ubuf_arr = ArrayType(uchar, 3)
var c__S___sFILE_FI__nbuf_arr = ArrayType(uchar, 1)
var longlong = exports.longlong = ref.types.longlong
var fpos_t = exports.fpos_t = longlong
var __sFILE = exports.__sFILE = Struct({
	_p: uchar_ptr,
	_r: int32,
	_w: int32,
	_flags: short,
	...
	_extra: __sFILEX_ptr,
	_ur: int32,
	_ubuf: c__S___sFILE_FI__ubuf_arr,
	_nbuf: c__S___sFILE_FI__nbuf_arr,
	_lb: __sbuf,
	_blksize: int32,
	_offset: fpos_t,
})
var FILE = exports.FILE = __sFILE
var FILE_ptr = exports.FILE_ptr = ref.refType(FILE)
var c__S_SDL_RWops_U_SDL_rwops_h_3164_S_SDL_rwops_h_3819 = exports.c__S_SDL_RWops_U_SDL_rwops_h_3164_S_SDL_rwops_h_3819 = Struct({
	autoclose: uint32,
	fp: FILE_ptr,
})
...
var c__S_SDL_RWops_U_SDL_rwops_h_3164 = exports.c__S_SDL_RWops_U_SDL_rwops_h_3164 = Union({
	stdio: c__S_SDL_RWops_U_SDL_rwops_h_3164_S_SDL_rwops_h_3819,
...
FFI.Library(__dirname + '/SDL2', {
	...
	SDL_RWFromFP: [ SDL_RWops_ptr, [ FILE_ptr, uint32, ] ],
